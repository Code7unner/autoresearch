...
3. Test whether it is configured:
...
```bash
autoresearch configure twitter-cookies "pasted cookie JSON"
```
...
> twitter-cli supports configuring a proxy via environment variables:
...
If you have already installed the [bird CLI](https://www.npmjs.com/package/@steipete/bird) (`npm install -g @steipete/bird`), it also works fine. autoresearch automatically detects and uses an installed bird. The two are functionally similar; twitter-cli is the currently recommended solution.

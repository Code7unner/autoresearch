...
> **Note**: `autoresearch install --channels douyin` does not yet support the Douyin channel (Douyin is in the "optional channels to be unlocked" list).
...
JSON through `autoresearch format hn` to strip noise and truncate huge comment

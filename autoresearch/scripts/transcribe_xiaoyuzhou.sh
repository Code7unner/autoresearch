...
# Try env var first, then autoresearch config.yaml
...
GROQ_API_KEY="${GROQ_API_KEY:?Please set the GROQ_API_KEY environment variable or run autoresearch configure groq-key}"
